...
class Etudiant{
    ...
    <div class="col-md-12">
       ...
       <i class="fas fa-graduation-cap"></i>
            ...
            <?php
              foreach ($info as $ep):
                  ?>
            <h1>Bonjour <?= $ep['prenom'] ?> ! </h1>
            <p>Tu trouveras dans cette section tes notes dans les différents modules dont tu es inscrit ainsi que la moyenne générale</p>
            <?php endforeach; ?>
            </div>
        </div>
  ...
  <img src="/images/graduated.png" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title"><?= $ep['nom'] ?> <?= $ep['prenom'] ?> </h5>
  </div>
  <ul class="list-group list-group-flush">
  
    <li class="list-group-item">Email: <strong><?= $ep['email'] ?></strong></li>
    <li class="list-group-item">Classe:<strong> <?= $ep['classe'] ?></strong></li>
    <?php endforeach; ?>
    <?php
  $moybuffer=0;
              foreach ($notes as $ep):
